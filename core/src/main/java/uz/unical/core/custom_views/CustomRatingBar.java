package uz.unical.core.custom_views;
...
public class CustomRatingBar extends ViewGroup {
    ...
    public static final int STAR_EMPTY = R.drawable.ic_disabled_star;
    public static final int STAR_HALF = R.drawable.ic_half_star;
    public static final int STAR_FULL = R.drawable.ic_star;
    ...
    private void initView(TypedArray a) {
        ...
        isCanChange = a.getBoolean(R.styleable.RB_isCanChange, true);
    ...
    private final List<ImageView> list = new ArrayList<ImageView>();

    private ImageView createChild() {
        ImageView imageView = new ImageView(mContext);
        imageView.setImageResource(R.drawable.ic_disabled_star);
    ...
    public void removeOnStarChangeListener() {
    ...
    private void updateStars(Float stars) {
        this.stars = stars * 2;
        checkState();
    }
    ...
    public void setStars(float stars) {
        if (isCanChange) updateStars(stars);
    }
